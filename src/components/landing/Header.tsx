  ...
  return (
    <header 
      className={cn(
        ...
        scrolled 
          ? "h-14 bg-campo/95 backdrop-blur-md shadow-md border-b border-white/5 sm:h-16" 
    ...
    >
      <div className="mx-auto h-full max-w-6xl px-4 flex items-center justify-between gap-2 sm:px-6 lg:px-8">
        ...
        <a href="#top" className="flex items-center gap-1.5 min-w-0 group shrink">
          ...
          <span className="font-display text-[13px] tracking-tight text-white whitespace-nowrap pt-0.5 truncate sm:text-lg lg:text-xl">
            Finanças em Campo
          </span>
        </a>
        ...
        <div className="flex items-center shrink-0">
          <Button 
            asChild 
            variant="apito" 
            className="rounded-full font-bold shadow-apito transition-transform hover:scale-105 active:scale-95 h-9 px-3 text-[11px] sm:h-11 sm:px-6 sm:text-sm shrink-0"
          >
            <a href="#cadastro">
